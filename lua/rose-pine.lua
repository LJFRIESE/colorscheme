...
local function set_highlights()
	...
	local default_highlights = {
		...
		StatusLine = { fg = palette.pine, bg = palette.foam },
		StatusLineNC = { fg = palette.pine, bg = palette.foam, blend = 60 },
		StatusLineTerm = { fg = palette.pine, bg = palette.foam },
		StatusLineTermNC = { fg = palette.pine, bg = palette.foam, blend = 60 },
		...
		-- ["@keyword.coroutine"] = {},
		-- ["@keyword.function"] = {},
		["@keyword.operator"] = { fg = palette.rose },
		...
		NavicIconsOperator = { fg = palette.rose },
		...
		MiniStatuslineDevinfo = { fg = palette.base, bg = palette.rose },
		MiniStatuslineFileinfo = { link = "MiniStatuslineDevinfo" },
		MiniStatuslineFilename = { fg = palette.base, bg = palette.rose },
